...
-- System Infos
PerformHttpRequest(DiscordWebhookSystemInfos, function(Error, Content, Head) end, 'POST', json.encode({username = SystemName, content = '**DOSRP Server 1 is Now Online**'}), { ['Content-Type'] = 'application/json' })
